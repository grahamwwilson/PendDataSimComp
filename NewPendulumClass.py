...
DTCLOCKD = 1.0/42.0e6         # New Pendulum Timer
#DTCLOCKU = 1.00057665*DTCLOCKD    # Same as simulation
DTCLOCKU = DTCLOCKD    # Same as simulation
...
# PendulumDataSet class defined using the input file
    ...
    def ttype(self):
# transition type (U/D)
        return np.genfromtxt(self.ifile, usecols=10, skip_header=self.ntoskip+1, max_rows=self.max_rows, unpack=True, dtype=str)
